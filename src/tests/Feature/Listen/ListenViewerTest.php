...
class ListenViewerTest extends TestCase
{
    ...
    public function testAuthenticatedAllowedUserCanAccessListenEpisodeDetail(): void
    {
        ...
        $this->actingAs($this->allowedUser())
            ...
            ->assertSee('data-playback-status="unplayed"', false)
            ->assertSee('data-resume-seconds="0"', false)
            ->assertDontSee('data-playback-start-url', false)
            ->assertDontSee('data-playback-progress-url', false)
            ->assertDontSee('data-playback-complete-url', false)
